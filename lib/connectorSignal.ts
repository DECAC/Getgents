...
export const REST_API_MANUAL_INSTRUCTION =
  ...
  "C'est ce bloc qui fait apparaître la carte « Appliquer la configuration » : sans lui, aucune carte ne s'affiche. Résume tes choix en quelques puces courtes dans le texte visible, mais mets toujours la configuration complète dans le bloc. Précise que l'API sera réellement appelée par le gent une fois la configuration appliquée et le gent publié. " +
  "Le créateur peut aussi le faire à la main dans l'onglet Connecteurs (« + Ajouter un connecteur » → « API REST ») : ne l'y renvoie que s'il le demande explicitement.";
